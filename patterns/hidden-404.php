...
<h2 class="has-text-align-center has-x-large-font-size">
    <?php echo esc_html_x( '404', 'Error code for a webpage that is not found.', 'wcus' ); ?>
</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
<p class="has-text-align-center">
    <?php echo esc_html_x( 'This page could not be found.', 'Message to convey that a webpage could not be found', 'wcus' ); ?>
</p>
<!-- /wp:paragraph -->
